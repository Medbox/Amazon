<?php
require('../lib/fpdf/writetag.php');

$pdf=new PDF_WriteTag();
$pdf->SetMargins(25,20,25);//left top right
...
// Title
$title="<img src='../img/login_logo.png' width='280' height='80'  alt=''/>";

$pdf->SetLineWidth(0.5);
$pdf->SetFillColor(255,255,204);
$pdf->SetDrawColor(102,0,102);
$pdf->WriteTag(0,10,$title,1,"C",1,5);
