...
<div class="ctr_wrap">
    ...
    <div class="ctr_body">
        ...
        números 13 (trece), que integran el programa número 23 (veintitrés), que va desde las 18.00 (dieciocho horas) pm hasta las 
        19.51 (diecinueve cincuenta y un minutos) pm, y los bloques de contenidos diferido número 13 (trece), que va desde 
        las 18.00 (dieciocho horas) pm hasta las 19.51 (diecinueve cincuenta y un minutos) pm, una semana los días Martes 
        y Jueves, y la siguiente semana los días Lunes, Miércoles y Viernes, y así sucesivamente cada semana. Horas estas, 
...
$(document).ready(function(e) {
	...
	$("#btn_descarga_contrato").click(function(){
        ...
        var href 	= 	"contrato_pdf_RPP_23.php?con_id="+con_id;
        var target 	= 	"_blank";		
