...
<div class="ctr_wrap">
    ...
    <div class="ctr_body">
        ...
        9 (nueve), que integran el programa número 30 (treinta), que va desde las 14.23 (catorce horas veintitrés minutos) 
        pm hasta las 15.11 (quince horas once minutos) pm, y los bloques de contenidos diferido número 9 (nueve), que va 
        desde las 14.23 (catorce horas veintitrés minutos) pm hasta las 15.11 (quince horas once minutos) pm, una semana los 
...
$(document).ready(function(e) {
	...
	$("#btn_descarga_contrato").click(function(){
        ...
        var href 	= 	"contrato_pdf_RPP_30.php?con_id="+con_id;
        var target 	= 	"_blank";		
