...
<div class="ctr_wrap">
    ...
    <div class="ctr_body">
        ...
        números 14 (catorce), que integran el programa número 14 (catorce), que va desde las 20.00 (veinte horas) pm hasta las 21.51 
        (veintiún horas cincuenta y un minutos) pm, y los bloques de contenidos diferido número 14 (catorce), que va desde 
        las 20.00 (veinte horas) pm hasta las 21.51 (veintiún horas cincuenta y un minutos) pm, una semana los días Lunes, 
        Miércoles y Viernes,  y la siguiente semana los días Martes y Jueves, y así sucesivamente cada semana. Horas estas, 
        que constituyen para el AFILIDADO, su jornada ordinaria de trabajo. 
        <br><br>
...
$(document).ready(function(e) {
	...
	$("#btn_descarga_contrato").click(function(){
        ...
        var href 	= 	"contrato_pdf_RPP_14.php?con_id="+con_id;
        var target 	= 	"_blank";		
