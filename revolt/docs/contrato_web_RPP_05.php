...
<div class="ctr_wrap">
    ...
    <div class="ctr_body">
        ...
        números 5 (cinco), que integran el programa número 5 (cinco), que va desde las 10.28 (diez horas veintiocho minutos) am 
        hasta las 11.16 (once horas dieciséis minutos) am, y los bloques de contenidos diferido número 5 (cinco), que va desde las 
        10.28 (diez horas veintiocho minutos) am hasta las 11.16 (once horas dieciséis minutos) am, una semana los días Lunes, 
...
$(document).ready(function(e) {
	...
	$("#btn_descarga_contrato").click(function(){
        ...
        var href 	= 	"contrato_pdf_RPP_05.php?con_id="+con_id;
        var target 	= 	"_blank";		
