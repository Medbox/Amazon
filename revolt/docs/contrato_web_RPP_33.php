...
<div class="ctr_wrap">
    ...
    <div class="ctr_body">
        ...
        12 (doce), que integran el programa número 33 (treinta y tres), que va desde las 17.06 (diecisiete horas seis minutos) 
        pm hasta las 17.51 (diecisiete horas cincuenta y un minutos) pm, todos los días martes de cada semana. Horas estas, 
...
$(document).ready(function(e) {
	...
	$("#btn_descarga_contrato").click(function(){
        ...
        var href 	= 	"contrato_pdf_RPP_33.php?con_id="+con_id;
        var target 	= 	"_blank";		
