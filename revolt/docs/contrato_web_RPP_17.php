...
<div class="ctr_wrap">
    ...
    <div class="ctr_body">
        ...
        número 17 (diecisiete), que va desde las 01.00 (una horas) am, hasta las 01.51 
        (doce hora veinte minutos) pm, que integra el programa numero 17 (diecisiete), que va de lunes a viernes de cada semana. 
...
$(document).ready(function(e) {
	...
	$("#btn_descarga_contrato").click(function(){
        ...
        var href 	= 	"contrato_pdf_RPP_17.php?con_id="+con_id;
        var target 	= 	"_blank";		
