...
<div class="ctr_wrap">
    ...
    <div class="ctr_body">
        ...
        números 13 (trece), que integran el programa número 13 (trece), que va desde las 18.00 (dieciocho horas) pm, hasta las 19.51 
        (diez y seis horas, cincuenta y siete minutos) pm, y los bloques de contenidos diferido número 13 (trece), que va desde 
        las 18.00 (dieciocho horas) pm, hasta las 19.51(diez y seis horas, cincuenta y siete minutos) pm, una semana los días 
...
$(document).ready(function(e) {
	...
	$("#btn_descarga_contrato").click(function(){
        ...
        var href 	= 	"contrato_pdf_RPP_13.php?con_id="+con_id;
        var target 	= 	"_blank";		
