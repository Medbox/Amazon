...
$obj_con->setContratoContrato($con_id,$fun_id);//CON_ID = 24 en este caso
...
<div class="ctr_wrap">
    ...
    <div class="ctr_body">
        ...
        REVOLT GAMES contrate al AFILIADO para que preste servicios como <?php echo $DATA_FUNCION; ?>
...
$(document).ready(function(e) {
	...
	$("#btn_descarga_contrato").click(function(){
        ...
        var href 	= 	"contrato_pdf_RPP_11b.php?con_id="+con_id;
        var target 	= 	"_blank";		
