...
contrate al AFILIADO para que preste servicios como '.$DATA_FUNCION.' número 1 (uno), que va desde las 6.40 (seis 
horas cuarenta minutos) am hasta las 7.28 (siete horas veintiocho minutos) am, que integran el programa numero 1 
(uno), que va de lunes a viernes de cada semana. Horas estas, que constituyen para el AFILIDADO, su jornada ordinaria 
de trabajo.
<br><br>
