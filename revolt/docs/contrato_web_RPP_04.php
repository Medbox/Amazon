...
<div class="ctr_wrap">
    ...
    <div class="ctr_body">
        ...
        número 4 (cuatro), que va desde las 9.31 (nueve treinta y uno minutos) am, 
        hasta las 10.19 (diez horas diecinueve minutos) am, que integra el programa numero 4 (cuatro), que va de lunes a 
        viernes de cada semana. Horas estas, que constituyen para el AFILIDADO, su jornada ordinaria de trabajo. 
        <br><br>
...
$(document).ready(function(e) {
	...
	$("#btn_descarga_contrato").click(function(){
        ...
        var href 	= 	"contrato_pdf_RPP_04.php?con_id="+con_id;
        var target 	= 	"_blank";		
