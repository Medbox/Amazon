...
<div class="ctr_wrap">
    ...
    <div class="ctr_body">
        ...
        número 12 (doce) que integra el programa número 12 (doce), que van desde las 17.06 (diez y siete horas, seis minutos) hasta 
        las 17.51 (diez y siete horas, cincuenta y un minutos, cada semana los días Lunes. Horas estas, que constituyen para 
        el AFILIDADO, su jornada ordinaria de trabajo. 
        <br><br>
...
$(document).ready(function(e) {
	...
	$("#btn_descarga_contrato").click(function(){
        ...
        var href 	= 	"contrato_pdf_RPP_12.php?con_id="+con_id;
        var target 	= 	"_blank";		
