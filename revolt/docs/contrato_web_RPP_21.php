...
<div class="ctr_wrap">
    ...
    <div class="ctr_body">
        ...
        número 21 (veintiuno), que va desde las 04.48 (cuatro horas cuarenta y ocho 
        minutos) am, hasta las 05.35 (cinco horas treinta y cinco minutos) am, que integra el programa numero 21 (veintiuno), 
        que va de lunes a viernes de cada semana. Horas estas, que constituyen para el AFILIDADO, su jornada ordinaria de trabajo. 
        <br><br>
...
$(document).ready(function(e) {
	...
	$("#btn_descarga_contrato").click(function(){
        ...
        var href 	= 	"contrato_pdf_RPP_21.php?con_id="+con_id;
        var target 	= 	"_blank";		
