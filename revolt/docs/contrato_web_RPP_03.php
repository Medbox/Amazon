...
<div class="ctr_wrap">
    ...
    <div class="ctr_body">
        ...
        número 3 (tres), que va desde las 8.34 (ocho horas treinta y cuatro minutos) am, 
        hasta las 9.22 (nueve horas veintidós minutos) am, que integra el programa numero 3 (tres), que va de lunes a viernes 
        de cada semana. Horas estas, que constituyen para el AFILIDADO, su jornada ordinaria de trabajo. 
        <br><br>
...
$(document).ready(function(e) {
	...
	$("#btn_descarga_contrato").click(function(){
        ...
        var href 	= 	"contrato_pdf_RPP_03.php?con_id="+con_id;
        var target 	= 	"_blank";		
