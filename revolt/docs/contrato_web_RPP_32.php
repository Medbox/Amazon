...
<div class="ctr_wrap">
    ...
    <div class="ctr_body">
        ...
        contrate al AFILIADO para que preste servicios como <?php echo $DATA_FUNCION; ?> números 
        11 (once), que integran el programa número 32 (treinta y dos), que va desde las 16.13 (dieciséis horas trece minutos) 
        pm hasta las 16.57 (dieciséis horas trece minutos) pm, y los bloques de contenidos diferido número 11 (trece), que va 
        desde las 16.13 (dieciséis horas trece minutos) pm hasta las 16.57 (dieciséis horas trece minutos) pm, una semana los 
        días Martes y Jueves, y la siguiente semana los días Lunes, Miércoles y Viernes, y así sucesivamente cada semana. 
...
$(document).ready(function(e) {
	...
	$("#btn_descarga_contrato").click(function(){
        ...
        var href 	= 	"contrato_pdf_RPP_32.php?con_id="+con_id;
        var target 	= 	"_blank";		
