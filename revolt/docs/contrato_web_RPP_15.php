...
<div class="ctr_wrap">
    ...
    <div class="ctr_body">
        ...
        números 15 (quince), que integran el programa número 15 (quince), que va desde las 22.00 (veintidós horas) pm hasta las 
        23.51 (veintitrés horas cincuenta y un minutos) pm, y los bloques de contenidos diferido número 15 (quince), que va desde 
        las 22.00 (veintidós horas) pm hasta las 23.51 (veintitrés horas cincuenta y un minutos) pm, una semana los días 
...
$(document).ready(function(e) {
	...
	$("#btn_descarga_contrato").click(function(){
        ...
        var href 	= 	"contrato_pdf_RPP_15.php?con_id="+con_id;
        var target 	= 	"_blank";		
