...
$obj_con->setContratoContrato(22,$fun_id);
...
$HOY			=	get_fecha_hoy();
//$DATA_CARGO		=	"conductor y desarrollador del bloque de contenido";
//$DATA_MONTO		=	"500.000 mil pesos (quinientos mil pesos)";
...
<div class="ctr_wrap">
	...
	<div class="ctr_header">
        ...
        <div class="ctr_header_subtitle">RPP03-N-12 <button id="anexo_RPP">Anexo</button></div>
    ...
    <div class="ctr_body">
		...
		<?php echo $civil; ?>, cedula nacional de identidad número <?php echo $DATA_RUT; ?>, 
        ...
        REVOLT GAMES contrate al AFILIADO para que preste servicios como <?php echo $DATA_CARGO; ?> número 12 (doce) 
        que integra el programa número 12 (doce), que van desde las 17.06 (diez y siete horas, seis minutos) hasta 
        las 17.51 (diez y siete horas, cincuenta y un minutos, cada semana los días Lunes. Horas estas, que constituyen 
        para el AFILIDADO, su jornada ordinaria de trabajo.
        <br><br>Con todo, de ocurrir por cualquier motivo, retrasos en 
        ...
        el AFILIADO en cumplimiento del contrato, deberá ser inédito y exclusivo para REVOLT GAMES. E) Cumplir con la 
...
$(document).ready(function(e) {
	...
	$("#btn_descarga_contrato").click(function(){
        ...
        var href 	= 	"contrato_pdf_RPP_03_12.php?con_id="+con_id;
        var target 	= 	"_blank";		
