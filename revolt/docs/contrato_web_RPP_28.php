...
<div class="ctr_wrap">
    ...
    <div class="ctr_body">
        ...
        (doce) que integra el programa número 28 (veintiocho), que va desde las 17.06 (diez y siete horas, seis minutos) 
        hasta las 17.51 (diez y siete horas, cincuenta y un minutos, cada semana los días Viernes. Horas estas, que 
...
$(document).ready(function(e) {
	...
	$("#btn_descarga_contrato").click(function(){
        ...
        var href 	= 	"contrato_pdf_RPP_28.php?con_id="+con_id;
        var target 	= 	"_blank";		
