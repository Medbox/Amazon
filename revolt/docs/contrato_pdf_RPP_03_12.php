...
class PDF extends FPDF
{
    ...
    /*function Header()
    {
        ...
        $this->Cell(190,50,'Contrato de Inclusión Afliliado','',0,'C');        
    }*/
    ...
    function cabecera()
    {
        ...
        $this->Cell(null,40,'Contrato de Inclusión Afliliado','',0,'C');        
    }
    ...
    function fondo($DATA_NOMBRE,$DATA_RUT)
    {
        ...
        //$this->Image('../img/firma_yamir.png',40,65,22,26.89);
		$this->Image('../img/firma_yamir.png',40,152,22,26.89);
    ...
    function articulos($DATA_CARGO,$DATA_RENTA_MONEDA,$DATA_RENTA_ESCRITA){
        ...
        $this->MultiCell(170,7,'REVOLT GAMES contrate al AFILIADO para que preste servicios como conductor y desarrollador del bloque de contenido número 12 (doce) que integra el programa número 12 (doce), que van desde las 17.06 (diez y siete horas, seis minutos) hasta las 17.51 (diez y siete horas, cincuenta y un minutos, cada semana los días Lunes. Horas estas, que constituyen para el AFILIDADO, su jornada ordinaria de trabajo. ',"","J");
        $this->ln(4);
        ...
        */
		...
		$this->Cell(145,7,'El AFILIADO, declara comprender que por la naturaleza y objeto del contrato,','',1,'L');		
        $this->MultiCell(170,7,"REVOLT GAMES, cuenta con la capacidad de representación del AFILIADO en todo lo que sea necesario, para promover, publicitar y promocionar tanto a la persona misma del AFILIADO; signo, símbolo o cualquier otro distintivo que se use para designarlo; como el contenido, bloque de contenido o programa que este conduzca o desarrolle;  y/o cualquier otro signo, símbolo o cualquier otros distintivo que se use para designar a REVOLT GAMES. Para el cumplimiento del o los fines antes descritos REVOLT GAMES, podrá servirse de la participación directa del AFILIADO en la forma que disponga.","J");
        $this->ln(4);
        $this->MultiCell(170,7,"REVOLT GAMES deberá pagar al AFILIADO, por todo el tiempo que este entregue fuera de las horas ordinarias o que no puedan ser imputadas a estas, tanto al desarrollo efectivo del o los fines planteado en el inciso anterior como en su traslado, al doble del precio de cada hora ordinaria de trabajo, calculadas en la forma a que se refiere el artículo tercero en su inciso segundo, además de todo gasto en que haya debido incurrir el AFILIADO con motivos traslado, alojamiento y alimentación. Solamente una vez por cada 30 (treinta) días REVOLT GAMES podrá exigir al AFILIADO, su participación directa en actividades para fines de promoción y publicidad en los términos antes descritos, que pudiera implicar su traslado por más de 1 (una) hora.  Y solo, una vez por cada 90 (noventa) días, la participación directa en actividades con fines de promoción y publicidad  en los términos antes descritos, obligara a REVOLT GAMES a cancelar al AFILIADO solo los gastos de traslado, alojamiento y alimentación.","J");
        $this->ln(4);
        $this->MultiCell(170,7,"Desde ya, REVOLT GAMES, podrá solicitarle al AFILIADO, todo aquel material auditivo, visual o audiovisual que necesite para promocionar o publicitar, a REVOLT GAMES, al AFILIADO  o su contenido, bloque de contenido o programa que este conduzca y desarrolle, así como toda intervención directa  del AFILIADO en actividades con idénticos fines.","J");
        $this->ln(4);
		$this->MultiCell(170,7,"Se entiende por intervención directa para el uso de este contrato, como la comparecencia personal del AFILIADO, al lugar que designe REVOLT GAMES, con el objeto de desarrollar actividades de promoción, fomento y publicidad de mismo AFILIADO, alguno de los bloques que el conduzca o desarrolle, o de REVOLT GAMES sea que este implique o no un traslado del AFILIADO.","J");
        $this->ln(4);
		$this->MultiCell(170,7,"Los pagos que den lugar este artículo deberán ser cancelados, a más tardar, hasta dentro del quinto día hábil contando desde el momento que se produce la exigencia o  se acuerda la solicitud, cuando el AFILIADO todavía no haya principiado con sus prestación de servicios como conductor o desarrollador de los bloques de contenido.","J");
        $this->ln(4);
		$this->MultiCell(170,7,"Con el objeto de facilitar a REVOLT GAMES la representación del AFILIADO, para los fines publicitario, promocionales y fomento, tanto del mismo AFILIADO, su contenido, programa o bloque de contenido que conduzca y desarrolle para REVOLT GAMES, frente a terceros, sean personas naturales o jurídicas, es que las partes, acuerdan suscribir, con dicho fin, un anexo a este contrato.","J");
        $this->ln(4);
		$this->MultiCell(170,7,"El AFILIADO tendrá siempre la libertad para poder celebrar contratos publicitarios, laborales o cualquier otro, con toda empresa, marca, producto o servicios, que estime conveniente, siempre que estos, no le impidan cumplir íntegramente con las disposiciones de este contrato y, especialmente, en lo que dice relación con los derechos publicitarios de REVOLT GAMES, que emanan de este artículo.","J");
        $this->ln(4);
