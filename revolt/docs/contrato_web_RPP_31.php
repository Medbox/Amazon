...
<div class="ctr_wrap">
    ...
    <div class="ctr_body">
        ...
        10 (diez), que integran el programa número 31 (treinta y uno), que va desde las 15.20 (quince horas veinte minutos) 
        pm hasta las 16.04 (dieciséis horas cuatro minutos) pm, y los bloques de contenidos diferido número 10 (diez), que 
        va desde las 15.20 (quince horas veinte minutos) pm hasta las 16.04 (dieciséis horas cuatro minutos) pm, una semana 
        los días Martes y Jueves, y la siguiente semana los días Lunes, Miércoles y Viernes, y así sucesivamente cada semana. 
...
$(document).ready(function(e) {
	...
	$("#btn_descarga_contrato").click(function(){
        ...
        var href 	= 	"contrato_pdf_RPP_31.php?con_id="+con_id;
        var target 	= 	"_blank";		
