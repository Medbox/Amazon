...
<div class="ctr_wrap">
    ...
    <div class="ctr_body">
        ...
        contrate al AFILIADO para que preste servicios como <?php echo $DATA_FUNCION; ?> 
        números 10 (diez), que integran el programa número 10 (diez), que va desde las 15.20 (quince horas veinte minutos) pm hasta 
...
$(document).ready(function(e) {
	...
	$("#btn_descarga_contrato").click(function(){
        ...
        var href 	= 	"contrato_pdf_RPP_10.php?con_id="+con_id;
        var target 	= 	"_blank";		
