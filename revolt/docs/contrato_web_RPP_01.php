...
<div class="ctr_wrap">
    ...
    <div class="ctr_body">
        ...
        <article>
        <span>Primero.- </span>Las partes acuerdan celebrar un contrato de prestaciones de servicios profesionales y 
        representación, regido por las normas civiles y comerciales chilenas aplicables al caso.
        </article>
        ...
        número 1 (uno), que va desde las 6.40 
        (seis horas cuarenta minutos) am hasta las 7.28 (siete horas veintiocho minutos) am, que integran el 
        programa numero 1 (uno), que va de lunes a viernes de cada semana. Horas estas, que constituyen para el 
        AFILIDADO, su jornada ordinaria de trabajo.
        <br><br>
...
$(document).ready(function(e) {
	...
	$("#btn_descarga_contrato").click(function(){
        ...
        var href 	= 	"contrato_pdf_RPP_01.php?con_id="+con_id;
        var target 	= 	"_blank";		
