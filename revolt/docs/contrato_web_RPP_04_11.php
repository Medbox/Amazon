...
$obj_con->setContratoContrato(23,$fun_id);

//$DATA_CONTRATO	=	$obj_con->getNombre();
...
$DATA_MONTO		=	$obj_con->getCon_renta();
...
$HOY			=	get_fecha_hoy();
//$DATA_CARGO		=	"conductor y desarrollador de los bloques de contenidos";
//$DATA_MONTO		=	"1.000.000 de pesos (un millón de pesos)";
...
<div class="ctr_wrap">
	...
	<div class="ctr_header">
        ...
        <div class="ctr_header_subtitle">RPP04-N-11 <button id="anexo_RPP">Anexo</button></div>
    ...
    <div class="ctr_body">
		...
		<?php echo $domiciliado; ?> en <?php echo $DATA_DOMICILIO; ?>, de la <?php echo $DATA_CIUDAD; ?>, ambos mayores de edad quienes exponen:
        </div>
        ...
        <article>
        <span>Segundo.- </span>El contrato de prestaciones de servicios profesionales tendrá por objeto que 
        REVOLT GAMES contrate al AFILIADO para que preste servicios como <?php echo $DATA_CARGO; ?>
        números 11 (once), que integran el programa número 11 (once), que va desde las 16.13 (diez y seis horas, 
        trece minutos) pm hasta las 16.57 (diez y seis horas, cincuenta y siete minutos) pm, y los bloques de 
        contenidos diferido número 11 (once), que va desde las 16.13(diez y seis horas, trece minutos) pm hasta 
        las 16.57 (diez y seis horas, cincuenta y siete minutos) pm, una semana los días Lunes, Miércoles y Viernes, 
        y la siguiente semana los días Martes y Jueves, y así sucesivamente cada semana. Horas estas, que constituyen 
        para el AFILIDADO, su jornada ordinaria de trabajo.<br><br>Con todo, de ocurrir por cualquier motivo, retrasos en 
        ...
        valor neto de <?php echo $DATA_MONTO; ?>, pagaderas cada 5 (cinco) de cada mes desde que se hagan efectivas las 
...
$(document).ready(function(e) {
	...
	$("#btn_descarga_contrato").click(function(){
        ...
        var href 	= 	"contrato_pdf_RPP_04_11.php?con_id="+con_id;
        var target 	= 	"_blank";		
