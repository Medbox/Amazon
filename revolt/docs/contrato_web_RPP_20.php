...
<div class="ctr_wrap">
    ...
    <div class="ctr_body">
        ...
        número 20 (veinte), que va desde las 03.52 (tres horas cincuenta y dos minutos) 
        am, hasta las 04.39 (cuatro horas treinta y nueve minutos) am, que integra el programa numero 20 (veinte), que va de 
        lunes a viernes de cada semana. Horas estas, que constituyen para el AFILIDADO, su jornada ordinaria de trabajo. 
        <br><br>
...
$(document).ready(function(e) {
	...
	$("#btn_descarga_contrato").click(function(){
        ...
        var href 	= 	"contrato_pdf_RPP_20.php?con_id="+con_id;
        var target 	= 	"_blank";		
