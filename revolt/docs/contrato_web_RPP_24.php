...
<div class="ctr_wrap">
    ...
    <div class="ctr_body">
        ...
        14 (catorce), que integran el programa número 24 (veinticuatro), que va desde las 20.00 (veinte horas) pm hasta 
        las 21.51 (veintiuna horas cincuenta y un minutos) pm, y los bloques de contenidos diferido número 14 (catorce), 
        que va desde las 20.00 (veinte horas) pm hasta las 21.51 (veintiuna horas cincuenta y un minutos) pm, una semana 
...
$(document).ready(function(e) {
	...
	$("#btn_descarga_contrato").click(function(){
        ...
        var href 	= 	"contrato_pdf_RPP_24.php?con_id="+con_id;
        var target 	= 	"_blank";		
