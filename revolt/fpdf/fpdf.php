...
var $cta;                // CUENTA CORRIENTE
var $pertinencia;        // valor pertinencia
var $categorizacion;     // valor categorizacion
var $nombre_funcionario; // nombre funcionario
var $rut_funcionario;    // rut funcionario
var $dependencia;        // dependencia (box)
var $tcn;                // tipo consulta (tipo de urgencia)
var $tipo_examen;
var $tipo_consulta;
var $nombre_paciente;
var $rut_paciente;
...
*                                                                              *
*******************************************************************************/
function FPDF($orientation='P', $unit='mm', $size='A4', $cta, $pertinencia, $categorizacion, $nombre_funcionario, $rut_funcionario, $dependencia = null,$tcn = null,$tipo_examen = null, $tipo_consulta = null, $nombre_paciente = null, $rut_paciente = null)
{
    $this->setCta($cta);
    $this->setPertinencia($pertinencia);
    $this->setCategorizacion($categorizacion);
    $this->setNombre_funcionario($nombre_funcionario);
    $this->setRut_funcionario($rut_funcionario);
    $this->setDependencia($dependencia);
    $this->setTcn($tcn);
    $this->setTipoExamen($tipo_examen);
    $this->setTipoConsulta($dependencia);
    $this->setNombre_paciente($nombre_paciente);
...
/**
    ...
    public function getRut_funcionario() {
        return $this->rut_funcionario;
    }

    public function setRut_funcionario($rut_funcionario) {
    ...
    public function setTipoExamen($tipo_examen) {
