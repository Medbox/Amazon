...
$rsr_id			=	$_GET["rsr_id"];
$pre_id			=	3;//3 interconsulta


//agregarBloque($dia_semana,$h_inicio,$h_fin,null,null,$fun_id,null,null,null,$rendimiento,$rsr_id,3)	


if(is_numeric($dia_semana) && ($h_inicio != "") && ($h_fin != "") && is_numeric($fun_id) && is_numeric($rendimiento) && is_numeric($rsr_id)){
